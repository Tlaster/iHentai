...
namespace iHentai.Services.EHentai.Model
{
    ...
    public class EHGalleryInformation
    {
        [HtmlItem(".gdt1")]
    ...
    public interface IEHGalleryImage
    {
        string Text { get; }
        string Link { get; }
    }

    public class EHGalleryPageNormalImage : IEHGalleryImage
    {
    ...
    public class EHGalleryPageLargeImage : IEHGalleryImage
    {
        [HtmlItem("a", Attr = "href")] public string Link { get; set; }
    ...
    public class EHGalleryTagCategory
    {
    ...
    public class EHGallery : IGallery
    {
