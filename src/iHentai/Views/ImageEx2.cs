...
{
    internal class ImageEx2 : Microsoft.Toolkit.Uwp.UI.Controls.ImageEx
    {
        public static readonly DependencyProperty ScriptGalleryThumbProperty = DependencyProperty.Register(
            nameof(ScriptGalleryThumb), typeof(ScriptGalleryThumb), typeof(ImageEx2),
            new PropertyMetadata(default(ScriptGalleryThumb), PropertyChangedCallback));

        private CancellationTokenSource _tokenSource2;
        private string _url;

        public ScriptGalleryThumb ScriptGalleryThumb
        {
            get => (ScriptGalleryThumb)GetValue(ScriptGalleryThumbProperty);
            set => SetValue(ScriptGalleryThumbProperty, value);
        }
        ...
        private static void PropertyChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                if (e.Property == ScriptGalleryThumbProperty)
                {
                    view.OnEhGalleryPageNormalImageChanged(e.NewValue as ScriptGalleryThumb);
                }
            }
        }
        ...
        private async void OnEhGalleryPageNormalImageChanged(ScriptGalleryThumb newValue)
        {
            try
            {
