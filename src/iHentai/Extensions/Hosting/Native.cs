...
namespace iHentai.Extensions.Hosting
{
    ...
    public static class Native
    {
                    ...
                    case JavaScriptErrorCode.ScriptException:
                        {
                            ...
                            var data = errorObject.ConvertToString().ToString();
        ...
        [DllImport(DllName)]
        internal static extern JavaScriptErrorCode JsObjectToInspectable(JavaScriptValue obj, [MarshalAs(UnmanagedType.IInspectable)]out System.Object inspectable);
